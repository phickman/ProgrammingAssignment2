## makeCacheMatrix creates a cache object for the inverse result
##  the functions are get/set to manage the matrix value
##  and getinverse/setinverse to manage the cached result
